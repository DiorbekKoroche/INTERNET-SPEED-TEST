...
#icon
image_icon=PhotoImage(file="For github/logo.png")
root.iconphoto(False,image_icon)

#images
Top=PhotoImage(file="For github/top.png")
Label(root,image=Top,bg="#1a212d").pack()

Main=PhotoImage(file="For github/main.png")
Label(root,image=Main,bg="#1a212d").pack(pady=(40,0))

button=PhotoImage(file="For github/button.png")
